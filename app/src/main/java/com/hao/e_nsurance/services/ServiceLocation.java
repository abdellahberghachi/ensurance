...
/**
 * Created by abarg on 05/04/2017.
 */
...
public class ServiceLocation extends Service {
    ...
    private class LocationListener implements android.location.LocationListener {
        ...
        public void onLocationChanged(Location location) {
            geoFire.setLocation(settings.getString(PREF_ID, "0"), new GeoLocation(location.getLatitude(), location.getLongitude()), new GeoFire.CompletionListener() {
                @Override
